...
public class SignUpPage extends BaseMethods {
    ...
    public void enterUsername(String username) {
        enterInfo(usernameField, username);
    }

    public void enterEmailAndConfirmIt(String emailAddress) {
        enterInfo(emailField, emailAddress);
        enterInfo(confirmEmailField, emailAddress);
    }

    public void enterPasswordAndConfirm(String password) {
        enterInfo(passwordField, password);
        enterInfo(confirmPasswordField, password);
    }
